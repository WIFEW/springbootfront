  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        this.$http.get('wuzipeisong/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/wuzipeisongDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
