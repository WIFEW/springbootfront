...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","margin":"20px 7% 20px 14%","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
      <el-form-item :style='{"margin":"0 4px 0 0","alignItems":"center","display":"flex","height":"auto"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>配送姓名</div>
        <el-input v-model="formSearch.peisongxingming" placeholder="配送姓名" clearable></el-input>
      </el-form-item>
	  ...
	  <el-button v-if="isAuth('peisongyuan','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 20px","margin":"0 4px 0 0","outline":"none","color":"#fff","borderRadius":"30px","background":"#f4740c","width":"auto","fontSize":"14px","lineHeight":"40px ","height":"40px"}' type="primary" @click="add('/index/peisongyuanAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        let searchWhere = {};
        if (this.formSearch.peisongxingming != '') searchWhere.peisongxingming = '%' + this.formSearch.peisongxingming + '%';
	      params['sfsh'] = '是';
        this.$http.get('peisongyuan/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/peisongyuanDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
